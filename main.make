...
OBJECTS := \
	...
	$(OBJDIR)/text.o \
	$(OBJDIR)/gltf.o \
	$(OBJDIR)/infinit_texture.o \
	$(OBJDIR)/simple_app.o \
	$(OBJDIR)/noise.o \
	$(OBJDIR)/main.o \
	$(OBJDIR)/scalar_field.o \
...
$(OBJDIR)/gltf.o: src/gKit/gltf.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/infinit_texture.o: src/infinit_texture.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/simple_app.o: src/simple_app.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
...
$(OBJDIR)/main.o: src/main.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/scalar_field.o: src/scalar_field.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
